 ...
 */
final class Version20251018114200 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE users (id UUID NOT NULL, username VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, first_name VARCHAR(255) NOT NULL, last_name VARCHAR(255) NOT NULL, first_login_status BOOLEAN NOT NULL, email VARCHAR(100) NOT NULL, phone VARCHAR(20) NOT NULL, organization_id INT NOT NULL, PRIMARY KEY (id))');
